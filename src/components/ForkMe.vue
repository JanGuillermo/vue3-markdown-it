<template lang="pug">
a.github-corner(:href='link', title='Fork Me On GitHub')
  svg.w-32.h-32(viewBox='0 0 250 250')
    path(v-for='svg in svgPaths', v-bind='svg')
</template>
...
export default {
  data() {
    return {
      link: 'https://github.com/JanGuillermo/vue3-markdown-it',
      svgPaths: [
        {
...
.github-corner {
  ...
  > svg {
    @apply absolute top-0 border-0 right-0;
